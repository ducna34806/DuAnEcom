    ...
    return (
        <div>
            ...
            <div className="w-full relative flex items-center flex-col lg:mt-[160px] mb:mt-[167px] lg:pb-16 bg-[#01100B]">
                {/* FEFER A FRIENDS */}
                <div className="lg:w-[1200px] mb:w-[342px] mb:h-[268px] lg:h-[342px] lg:-mt-7 grid place-items-center rounded-3xl -translate-y-1/2 lg:bg-gradient-to-r mb:bg-[#346654] from-[#05422C] to-[#F2BC1B]">
                ...
                {/* LIST SERVICE */}
                <div className="lg:w-[1130px] lg:translate-x-4 mb:translate-x-[-1px] lg:-mt-1 mb:mt-3 py-8 grid lg:grid-cols-[548px_548px] mb:grid-cols-[159px_159px] lg:auto-rows-[300px] mb:auto-rows-[312px] justify-between lg:gap-y-[65px] mb:gap-y-[31px] mb:gap-x-[24px] lg:gap-x-0">
                    {/* item */}
                    <div className="grid lg:grid-rows-[144px_auto] mb:grid-rows-[64px_auto] text-white text-center justify-start lg:gap-y-[26px] mb:gap-y-3.5">
                        <div className="relative">
                            ...
                            <img
                                ...
                                className="mx-auto mb:w-10 mb:h-14 lg:w-auto lg:h-auto lg:mt-3"
                                alt=""
                            />
                        </div>
                    ...
                    <div className="grid lg:grid-rows-[144px_auto] mb:grid-rows-[64px_auto] text-white text-center justify-start lg:gap-y-[26px] mb:gap-y-3.5">
                        <div className="relative">
                            ...
                            <img
                                ...
                                className="mx-auto mb:w-16 mb:h-16 lg:w-auto lg:h-auto"
                                alt=""
                            />
                        </div>
                        <div className="flex flex-col lg:gap-y-[26px] mb:gap-y-4">
                    ...
                    <div className="grid lg:grid-rows-[144px_auto] mb:grid-rows-[64px_auto] text-white text-center justify-start lg:gap-y-[26px] mb:gap-y-4">
                        ...
                        <div className="flex flex-col lg:gap-y-[26px] mb:gap-y-4">
                            ...
                            <p className="lg:text-base lg:font-medium mb:font-light mb:text-[14px] opacity-60 whitespace-normal lg:tracking-[-0.15px]">
                                ...
                                Canada Post Xpresspost. We will provide you with
                                a tracking number so then you can follow your
