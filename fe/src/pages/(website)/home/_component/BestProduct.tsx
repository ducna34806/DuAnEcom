        ...
        <>
            ...
            <div className="w-full text-center lg:py-[120px] mb:pt-16 mb:pb-[42px]">
                ...
                <div className="w-full flex justify-center lg:my-[62px] mb:mt-8">
                    <div className="lg:grid hidden_scroll_x lg:grid-cols-[378.67px_378.67px_378.67px] mb:flex mb:w-[342px] lg:w-auto mb:overflow-x-auto lg:ml-0 mb:flex-nowrap *:mb:px-[20px] *:whitespace-nowrap *:lg:px-0 md:gap-x-[32px] grid-flow-row \ mb:gap-x-[16px] *:mb:h-[40px] *:sm:h-[48px] *:lg:text-base *:mb:text-sm *:rounded-[100px] *:bg-[#F2F6F4">
                ...
                <div className="w-full relative flex sm:flex-row mb:flex-col mb:items-center justify-center lg:my-16 mb:my-[22px] mb:overflow-x-auto hidden_scroll_x">
                    <div className="lg:w-[1440px] flex justify-end *:lg:h-[568px] *:sm:h-[350px] overflow-hidden">
                        <div className="grid sm:gap-x-[32px] mb:w-[342px] sm:w-[95vw] mb:gap-y-10 sm:gap-y-0 sm:grid-cols-[379px_auto] mb:flex-col items-center lg:w-[1348px] rounded-xl lg:translate-x-[28px]">
                            ...
                            {/* product desktop */}
                            <div className="h-full overflow-x-auto mb:hidden sm:block hidden_scroll_x">
                                <div className="grid grid-flow-col auto-cols-[291px] *:w-full h-full gap-x-[32px] h-[568px]">
                                    {/* item 1 */}
                                    <div className="flex flex-col justify-between h-full overflow-hidden rounded-xl">
                                        {/* img */}
                    ...
                    <div className="sm:hidden w-full custome_scroll_x_center_item snap-x mt-8 h-full h-[568px] overflow-x-auto hidden_scroll_x">
                        <div className="grid grid-flow-col auto-cols-[291px] *:w-full h-full gap-x-6 h-[568px]">
                            {/* item 1 */}
                            <div className="flex flex-col h-full overflow-hidden snap-center gap-y-6 rounded-xl">
                                {/* img */}
