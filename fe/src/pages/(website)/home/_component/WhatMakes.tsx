                    ...
                    <div className="lg:w-[1200px] mb:w-[342px] flex flex-col">
                        ...
                        <div className="lg:w-[789px] flex flex-col">
                            ...
                            <p className="text-[#717378] lg:my-6 lg:text-base mb:text-[14px] my-4">
                                ...
                                online marijuana dispensary in Canada, we could
                                wax lyrical about our positive qualities.
                                Instead, to make this information clearer, we’ve
                                highlighted the six prioritized features that we
                                feel makes us a cut above the rest.
                            </p>
                        </div>
                        {/* BOX */}
                                ...
                                <div className="flex flex-col lg:gap-y-8 mb:gap-y-1.5 justify-between lg:p-[32px] mb:px-3.5 mb:pb-3.5 rounded-xl border">
                                    ...
                                    <div className="flex flex-col gap-y-6">
                                        ...
                                        <p className="text-[#717378] lg:-mt-1.5 -mt-[6.5px] lg:text-[14px] mb:text-[12px]">
                                            Whether it is answering any
                                            questions you have before making a
                                            purchase, helping out with the
                                            buying process itself or taking your
                                            feedback under consideration, we are
                                            proud to provide high quality
                                            customer service that makes you –
                                            the customer – the most important
                                ...
                                <div className="flex flex-col lg:gap-y-8 mb:gap-y-1.5 justify-between lg:p-[32px] mb:px-3.5 mb:pb-3.5 rounded-xl border">
                                    ...
                                    <div className="flex flex-col gap-y-6">
                                        ...
                                        <p className="text-[#717378] lg:-mt-1.5 mb:tracking-[0.08px] -mt-[7px] lg:text-[14px] mb:text-[12px]">
                                            When it comes to security, we only
                                            keep what details are necessary for
                                            you to have an account with us and
                                            make an order. When it comes to
                                            shipping your mail order marijuana
                                            out, we use only tamper-proof and
                                            discrete packaging so then what
                                            you’ve purchased is your business
                                            only.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="flex flex-col lg:gap-y-8 mb:gap-y-1.5 justify-between lg:p-[32px] mb:px-4 mb:pb-3.5 rounded-xl border">
                                    ...
                                    <div className="flex flex-col gap-y-6">
                                        ...
                                        <p className="text-[#717378] lg:-mt-1.5 -mt-[6.8px] lg:text-[14px] mb:text-[12px]">
                                            ...
                                            supply and our prices to ensure that
                                            we maintain an optimal balance of
                                            affordable and quality for our
                                            products. We invest in the best
                                            quality strains that we can find and
                                            are always on the lookout for new,
                                            affordable and high quality weed
                                            products.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="flex flex-col lg:gap-y-8 mb:gap-y-[2.5px] justify-between lg:pt-[32px] lg:px-[32px] lg:pb-[95px] mb:px-4 mb:pb-3.5 rounded-xl border">
                                    ...
                                    <div className="flex flex-col gap-y-6">
                                        ...
                                        <p className="text-[#717378] lg:-mt-1 -mt-[6.7px] lg:text-[14px] mb:text-[12px]">
                                            ...
                                            transit, we will send you a
                                            replacement completely free of
                                            charge. Free Canada Post Xpress
                                ...
                                <div className="flex flex-col lg:gap-y-8 mb:gap-y-[2px] justify-between lg:p-[32px] mb:px-4 mb:pb-3.5 rounded-xl border">
                                    ...
                                    <div className="flex flex-col gap-y-6">
                                        ...
                                        <p className="text-[#717378] lg:-mt-1 -mt-1.5 lg:text-[14px] mb:text-[12px]">
                                            All of our cannabis products are
                                            tested to ensure that they are the
                                            highest quality possible. We work
                                            with expert suppliers and are always
                                            revising what makes a quality
                                            cannabis product to ensure that we
                                            have only the best available.
                                        </p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="flex flex-col lg:gap-y-8 mb:gap-y-[2.5px] justify-between lg:pt-[32px] lg:px-[32px] lg:pb-[95px] mb:px-4 mb:pb-3.5 border rounded-xl">
                                    ...
                                    <div className="flex flex-col gap-y-6">
                                        ...
                                        <p className="text-[#717378] lg:-mt-1 -mt-2 lg:text-[14px] mb:text-[12px]">
                                            With over 15 years in the weed
                                            business, you can rest assured that
                                            you will be taken care of. You can
                                            guarantee that we have your best
                                            interests in mind. Feel free to
