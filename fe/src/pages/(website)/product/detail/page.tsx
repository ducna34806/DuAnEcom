const DetailProduct = () => {
    return (
        <>
            {/* main */}
            <main className="w-full *:lg:w-[1312px] *:w-[342px] *:mx-auto *:h-full lg:py-10 mb:py-6 lg:mt-0 mb:mt-0.5 lg:mb-[316px]">
                    ...
                    <div className="h-full w-full *:w-full lg:mt-0 mb:mt-[42px]">
                        <div className="flex flex-col lg:gap-y-5">
                            ...
                            <div className="lg:h-[211px] flex flex-col lg:gap-y-4">
                                ...
                                <div className="flex justify-between lg:items-center mb:items-end">
                            ...
                            <div className="flex flex-col lg:gap-y-[22px] border-t lg:mt-[5px] lg:py-5 mb:py-6">
                                ...
                                <section className="bg-[#FEF8E8] lg:tracking-0 tracking-[0.0002px] px-3.5 py-2 rounded-[100px] lg:w-[342px] lg:mt-0 mb:mt-[18px] mb:w-full text-sm">
                                    ...
                                    <span className="text-[#EB2606]">80</span>{" "}
                                    Points!
                                </section>
                            </div>
                            {/* row 5 */}
                        ...
                        <div className="flex flex-col border-t lg:py-10 lg:mt-10 mb:py-[34px] mb:mt-8">
                            ...
                            <div className="show_description">
                                <section className="flex flex-col text-sm text-[#46494F] leading-[21px] gap-y-4 lg:py-6 mb:pt-[19px]">
                                    <p>
                                        ...
                                        sativa) created through crossing the
                                        infamous Slurricane X Gorilla Glue #4
                                        strains. Named for its gorgeous
                                        appearance and breeder, Jungle Diamonds
                                        is a favorite of indica and hybrid
                                        lovers alike thanks to its delicious
                                        taste and tingly, arousing high. Jungle
                                        Diamonds buds have sparkling oversized
                                        spade-shaped olive green nugs with vivid
                                        amber hairs and a thick frosty blanket
                                        of glittering tiny blue-tinted white
                                        crystal trichomes. As you pull apart
                                        each sticky little nugget, aromas of
                                        spicy mocha coffee and fruity herbs are
                                        released.{" "}
                                    </p>
                                    <p>
                                        The flavor is of sweet chocolate with
                                        hints of fresh ripe berries to it, too.
                                        The Jungle Diamonds high is just as
                                        delicious, with happy effects that will
                                        boost the spirits and kick negative
                                        thoughts and moods to the curb. You'll
                                        feel a tingly sense in your body from
                                        start to finish that serves to remove
                                        any aches or pains while leaving you
                                        pretty aroused at times. This is
                                        accompanied by a blissfully unfocused
                                        heady lift that leaves your head in the
                                        clouds without causing sedation. With
                                        these effects and its pretty high 17-24%
                                        THC level, Jungle Diamonds is ideal for
                                        experienced patients with chronic pain,
                                        cramps or muscle spasms and appetite
                                        loss or nausea.
                                    </p>
                                </section>
                            </div>
                            {/* detail comment */}
                            <section className="hidden show_review">
                                <div className="flex flex-col text-sm text-[#46494F] leading-[21px] gap-y-4 lg:pt-6 mb:pt-5 mb:pb-0">
                                    ...
                                    <div className="flex flex-col gap-y-6 border-t lg:pt-7 lg:pb-[22px]">
                                        ...
                                        <form className="-mt-1.5">
                                            ...
                                            <div className="mt-2 overflow-hidden border border-gray-200 rounded-lg shadow-sm lg:p-4 focus-within:border-none focus-within:ring-1 focus-within:none">
                                                <textarea
                                                    id="OrderNotes"
                                                    className="w-full align-top border-none outline-none resize-none focus:ring-0 sm:text-sm"
                                                    rows={3}
                            ...
                            <div className="hidden show_refer">
                                <div className="rounded-2xl lg:px-6 lg:pt-7 lg:pb-4 mb:p-5 border flex flex-col gap-y-5 mt-5 mb-[23px]">
                                    ...
                                    <section className="*:p-4 mt-1 *:bg-[#F3FBF4] flex flex-col gap-y-6 *:rounded-xl border-b pb-6">
                                        <div className="flex justify-between item-center gap-x-3">
                                            ...
                                            {/* text */}
                                            <span className="flex flex-col text-sm font-light gap-y-2">
                                                Your Referral URL
                                                <strong className="text-base font-medium">
                                                    Referral code is available
                                                    only to users with at least
                                                    one order.
                                                </strong>
                                            </span>
                                            {/* coppy */}
                                        ...
                                        <div className="grid mt-1 lg:grid-cols-[42%_42%_auto] items-end justify-between gap-y-4">
                                            ...
                                            <div className="flex flex-col items-start gap-y-2">
                                                <input
                                                    ...
                                                    className="w-full p-3 font-normal text-black border rounded-lg outline-none placeholder:text-black"
                                                />
                                            </div>
                                            <div className="flex flex-col items-start gap-y-2">
                                                <input
                                                    ...
                                                    className="w-full p-3 font-normal text-black border rounded-lg outline-none"
                                                />
                                            </div>
                                        </div>
                                        {/*btn show more */}
